...
Під час першого виклика функції `висловлювання` ми вказуємо лише рядок ('Привіт'), і він друкує рядок один раз. Під час другого виклика функції `висловлювання` ми вказуємо і рядок ('Привіт'), і аргумент `5`, показуючи, що ми хочемо *надрукувати* повідомлення рядка 5 разів.
...
:::::{tab-set}
::::{tab-item} українська
**код python** [function_varargs_ukr.py](programs/function_varargs_ukr.py):
...
::::
::::{tab-item} англійська
**python code** [function_varargs_en.py](programs/function_varargs_en.py):
:::{literalinclude} programs/function_varargs_en.py
:::
**output**:
:::{literalinclude} programs/function_varargs_en.txt
:::
::::
:::::
